...
{p 4 8}{cmd:sleep(real)} changes the pause in ms between attempts to write/open a file.
...
{p 6 8}{stata mmat2tex test1 using test.tex ,  replace  coefficients(pos((1,2) (2,3)) par levels(0.05,0.01,0.001)) }{p_end}
...
Any remaining errors are my own.{p_end}
